...
use kdeconnect::{
	...
	packets::{
		...
		SystemVolumeRequest, SystemVolumeStream, Telephony, TelephonyEvent,
	},
	KdeConnectError,
};
...
impl DeviceHandler for KConnectHandler {
	...
	// TODO
	async fn handle_telephony(&mut self, _packet: Telephony) {}
...
pub enum KConnectTelephonyEvent {
	MissedCall,
	Ringing,
	Talking,
}

impl From<KConnectTelephonyEvent> for TelephonyEvent {
	fn from(value: KConnectTelephonyEvent) -> Self {
		use KConnectTelephonyEvent as E;
		match value {
			E::MissedCall => Self::MissedCall,
			E::Ringing => Self::Ringing,
			E::Talking => Self::Talking,
		}
	}
}
